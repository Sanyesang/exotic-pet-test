...
const careGuides = {
  ...
  'black-king-snake': {
    environment: '25-30°C热区 · 22-24°C冷区 · 湿度40-60% · 60cm箱子',
    feeding: '冻鼠 · 幼体5天 · 成体7-10天 · 比玉米蛇还能吃',
    maintenance: '排便后清理 · 每月换垫材 · 水盆常换水',
    tips: '比玉米蛇还温顺 · 黑色鳞片超酷 · 新手友好 · 不咬人',
    commonIssues: '拒食（少见） · 呼吸道感染 · 体外寄生虫'
  },
  'syrian-hamster': {
    environment: '20-24°C · 湿度40-60% · 60cm笼子带跑轮 · 垫材厚铺',
    feeding: '仓鼠专用粮+少量蔬菜水果 · 2-3天喂一次 · 无限量清水',
    maintenance: '每周换部分垫材 · 每月全面清理 · 跑轮定期清洗',
    tips: '独居不能合笼 · 喜欢囤粮别清理 · 夜行动物白天别打扰 · 寿命仅2年',
    commonIssues: '湿尾病（腹泻） · 肿瘤 · 牙齿过长 · 冬眠伪死'
  },
  'fancy-rat': {
    environment: '20-26°C · 湿度40-60% · 多层铁网笼 · 需要攀爬和躲藏',
    feeding: '大鼠专用粮+蔬菜水果+少量蛋白质 · 每天喂 · 无限量清水',
    maintenance: '每周换2次垫材 · 每天清洗食盆 · 需要每天放风互动',
    tips: '需要群居养两只以上 · 智商高会学把戏 · 爱干净会自洁 · 寿命仅2-3年',
    commonIssues: '呼吸道感染（最常见） · 肿瘤 · 皮肤病 · 牙齿过长'
  },
  'dwarf-hamster': {
    environment: '20-24°C · 湿度40-60% · 仓鼠笼带跑轮 · 垫材厚铺至少5cm',
    feeding: '仓鼠专用粮+少量蔬菜 · 2-3天喂一次 · 无限量清水',
    maintenance: '每周换部分垫材 · 每月全面清理 · 跑轮需要清洗',
    tips: '独居绝对不要合笼 · 体型小容易越狱 · 寿命1.5-3年 · 适合学生',
    commonIssues: '湿尾病 · 糖尿病（一线易得） · 眼睛发炎 · 摔伤'
  },
  'budgie': {
    environment: '18-26°C · 笼子40cm+带横杆 · 避风避直射阳光 · 需要玩具',
    feeding: '虎皮鹦鹉专用粮+蔬菜水果 · 每天喂 · 墨鱼骨补钙',
    maintenance: '每天换水换食 · 每周清理笼底 · 定期剪飞羽（可选）',
    tips: '从小养学说话 · 每天放出笼子飞 · 最好养一对 · 镜子会让它自恋',
    commonIssues: '啄羽症（无聊） · 肥胖 · 呼吸道感染 · 难产（缺钙）'
  },
  'cockatiel': {
    environment: '20-28°C · 笼子50cm+ · 避风 · 需要玩具和站架',
    feeding: '鹦鹉专用粮+蔬菜水果 · 每天喂 · 墨鱼骨补钙',
    maintenance: '每天换水换食 · 每周清理笼底 · 每天需要出笼陪伴',
    tips: '公鸟会吹口哨 · 需要每天陪伴不然抑郁 · 寿命15年+ · 粘人程度堪比狗',
    commonIssues: '啄羽症（孤独） · 肥胖 · 呼吸道感染 · 缺钙抽搐'
  },
  'fat-tailed-gecko': {
    environment: '28-32°C热区 · 24-26°C冷区 · 湿度50-70% · 30cm盒子即可',
    feeding: '面包虫蟋蟀 · 幼体每天 · 成体隔天 · 每周补钙粉',
    maintenance: '每天清粪便 · 每月换垫材 · 水盆保持干净',
    tips: '比豹纹守宫还温顺 · 大尾巴超萌 · 新手首选 · 同样好养',
    commonIssues: '拒食温度不够 · 脱皮不顺利 · 尾巴自切（极少）'
  },
  'day-gecko': {
    environment: '25-30°C · 湿度60-80% · 雨林缸带植物 · 需要UVB灯',
    feeding: '果泥+蟋蟀粉+蜂蜜水 · 2-3天喂一次 · 需要钙粉',
    maintenance: '每天喷水保持湿度 · 每周清理缸体 · 定期修剪植物',
    tips: '白天活跃观赏性强 · 需要UVB灯 · 不要上手把玩 · 适合老手',
    commonIssues: '缺钙（无UVB） · 脱水湿度不够 · 皮肤感染'
  },
  'snapping-turtle': {
    environment: '水温24-28°C · 大水体100L+ · 强力过滤 · 不需要晒台',
    feeding: '鱼虾肉泥鳅 · 幼体2天一次 · 成体3-4天一次 · 能吃任何肉',
    maintenance: '每周换1/3水 · 清洗过滤器 · 注意咬手！千万别上手',
    tips: '非常凶猛会咬断手指 · 纯观赏不要把玩 · 能长很大需要足够空间',
    commonIssues: '腐甲水质差 · 肺炎水温低 · 缺钙软壳 · 过滤不够水质恶化'
  },
  'milk-snake': {
    environment: '25-30°C热区 · 22-24°C冷区 · 湿度40-60% · 60cm箱子',
    feeding: '冻鼠 · 幼体5天 · 成体7-10天 · 食欲好不挑食',
    maintenance: '排便后清理 · 每月换垫材 · 水盆常换水',
    tips: '颜色鲜艳像糖果 · 比玉米蛇还好动 · 新手友好 · 基因选择多',
    commonIssues: '拒食（少见） · 呼吸道感染 · 体外寄生虫'
  }
}
